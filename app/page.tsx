  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            <Link href="/track" className="text-sm font-medium hover:underline">
              Track Order
            </Link>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted py-16 md:py-24 lg:py-32">
          <div className="container flex flex-col items-center text-center">
            ...
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
              <span className="text-amber-500">Simplify</span> Your Jewellery Billing
            </h1>
        ...
        {/* Features Section */}
        <section id="features" className="container py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-8">
          <div className="mx-auto mb-12 md:mb-16 flex max-w-[58rem] flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-[95%] md:max-w-[85%] text-base md:text-lg text-muted-foreground">
              Streamline your billing process with our powerful features designed specifically for jewellery retailers.
            </p>
          </div>
          <div className="grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center rounded-lg border bg-card p-6 md:p-8 text-center shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Generate professional bills automatically with customizable templates tailored for jewellery items.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="flex flex-col items-center rounded-lg border bg-card p-6 md:p-8 text-center shadow-sm transition-all hover:shadow-md">
              ...
              <h3 className="mb-2 text-xl font-bold">Due Reminders via WhatsApp</h3>
              <p className="text-muted-foreground">
                Automated payment reminders sent directly to your customers via WhatsApp to ensure timely payments.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="flex flex-col items-center rounded-lg border bg-card p-6 md:p-8 text-center shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Download and share professional PDF invoices with your customers with just a single click.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center rounded-lg border bg-card p-6 md:p-8 text-center shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Manage repair requests with real-time status updates and automated customer notifications.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center rounded-lg border bg-card p-6 md:p-8 text-center shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Track custom orders from design to delivery with a comprehensive timeline visible to both you and your
                customers.
              </p>
            </div>
          </div>
          ...
          <div className="container">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
              <div className="md:w-1/2">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Track Your Repair or Order</h2>
                <p className="text-lg text-muted-foreground mb-6">
                  Stay updated on the status of your jewellery repair or custom order with our real-time tracking
                  system.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    ...
                    <p>Enter your unique tracking ID provided at the time of order</p>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-2 mt-1 h-5 w-5 rounded-full bg-amber-200 flex items-center justify-center">
                      <span className="text-amber-700 text-xs">2</span>
                    </div>
                    <p>View real-time status updates of your repair or custom order</p>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-2 mt-1 h-5 w-5 rounded-full bg-amber-200 flex items-center justify-center">
                      <span className="text-amber-700 text-xs">3</span>
                    </div>
                    <p>Receive notifications when your item is ready for pickup</p>
                  </li>
                </ul>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 pb-4 border-b">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Custom Gold Necklace</p>
                        </div>
                        <Badge className="ml-auto bg-amber-100 text-amber-800 hover:bg-amber-100">In Production</Badge>
                      </div>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-amber-600">In Production</span>
                        </div>
                        <div className="flex justify-between text-sm">
        ...
        <section className="bg-white px-4 sm:px-6 md:px-8">
          <div className="container py-12 md:py-16 lg:py-24">
            <div className="flex flex-col items-center justify-between gap-6 md:gap-8 rounded-lg border border-amber-200 bg-white p-6 md:p-8 lg:p-12 shadow-lg md:flex-row">
              <div>
                <h3 className="text-xl font-bold md:text-2xl lg:text-3xl">Ready to transform your billing process?</h3>
                <p className="mt-2 text-muted-foreground">
                  Join thousands of jewellers who have simplified their business operations.
                </p>
              </div>
              <Button size="lg" className="w-full md:w-auto bg-amber-500 hover:bg-amber-600" asChild>
        ...
        <div className="container py-8 md:py-12 px-4 sm:px-6 md:px-8">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Simplifying jewellery billing since 2023.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="text-muted-foreground">Email: contact@Lakhijewellers.com</li>
                <li className="text-muted-foreground">Phone: +91 98765 43210</li>
                <li className="text-muted-foreground">Address: 123 Jewellery Lane, Mumbai</li>
              </ul>
            </div>
          </div>
          <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Lakhi Jewellers Billing. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
